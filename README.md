...
<!-- PROJECT DESCRIPTION -->
# 📖 [About the Project - Template - Project with Webpack & Gitflow.] <a name="about-project"></a>

**to_do_list** It's a TEMPLATE to setup a project for an application using Webpack & Gitflow.
...
- **Following Gitflow branch & pull request flow**
...
```sh
  ...
  git clone https://github.com/jcmunav63/
```
